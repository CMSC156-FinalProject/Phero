...
class _AccountSettingsScreenState extends State<AccountSettingsScreen> {
  ...
  // Admin Application Dialog (Saves to 'admin_applications' collection in Firestore)
  void _showAdminApplicationDialog(
    BuildContext context,
    bool isDark,
    Color primary,
    Color bg,
          ...
          return AlertDialog(
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Text(
                    'Enter your email and a detailed reason for admin privileges.',
                    style: TextStyle(
              ...
              ElevatedButton(
                ...
                onPressed: isLoading
                    ...
                    : () async {
                        ...
                        try {
                          // Submitting application details directly to root-level firestore collection "admin_applications"
                        ...
                        children: [
                          ...
                          if (!isAdmin) ...[
                            ...
                            _buildMenuItem(
                              ...
                              subText: subText,
                              textColor: textColor,
                              onTap: () => _showAdminApplicationDialog(
                                context,
                                isDark,
                                primary,
                                bg,
...
class _PersonalInfoScreenState extends State<PersonalInfoScreen> {
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      setState(() {
        _feedbackMessage = e.message ?? 'An error occurred.';
        _isError = true;
      });
    } catch (_) {
      setState(() {
                      ...
                      if (_feedbackMessage != null) ...[
                        Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 13,
                              color: _isError ? Colors.red : primary,
                            ),
                          ),
                        ),
                        const SizedBox(height: 16),
